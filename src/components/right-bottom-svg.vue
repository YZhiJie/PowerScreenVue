<template>
  ...
  >
    <defs>
      ...
      <!-- <filter id="hy-filter" x="275" y="10" width="50" height="50" filterUnits="userSpaceOnUse"> -->
    ...
    <template v-for="(item, index) in dots" :key="index">
      <circle class="hy-cls-3" cx="0" cy="0" :r="item.value">
        <animateMotion :dur="item.dur" :begin="item.begin" repeatCount="indefinite" rotate="auto">
