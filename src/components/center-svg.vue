  ...
  <div class="center-svg">
    ...
    >
      <defs>
        ...
        <image id="image" width="23" height="23" xlink:href="@/assets/images/image-1.png" />
        <image id="image-2" width="15" height="15" xlink:href="@/assets/images/image-2.png" />
      </defs>
      <g id="dongxiao1">
        <g id="icon">
          <path
          ...
          <image
            ...
            width="112"
            height="112"
            xlink:href="@/assets/images/star.png"
          />
          <path
            id="base_o-2"
            data-name="base_o"
          ...
          <image
            ...
            width="106"
            height="107"
            xlink:href="@/assets/images/location.png"
          />
          <path
            id="base_o-3"
            data-name="base_o"
          ...
          <image
            ...
            width="107"
            height="108"
            xlink:href="@/assets/images/pie.png"
          />
          <path
            id="base_o-4"
            data-name="base_o"
          ...
          <image
            ...
            width="111"
            height="112"
            xlink:href="@/assets/images/earth.png"
          />
          <path
            id="base_o-5"
            data-name="base_o"
          ...
          <image
            ...
            width="105"
            height="105"
            xlink:href="@/assets/images/hot.png"
          />
          <path
            id="base_o-6"
            data-name="base_o"
          ...
          <image
            ...
            width="103"
            height="103"
            xlink:href="@/assets/images/home.png"
          />
        </g>
        <g id="circle">
          <path
          ...
          <image
            ...
            width="72"
            height="92"
            xlink:href="@/assets/images/light_o_3.png"
          />
          <image
            id="light_o_2"
            x="141"
            ...
            width="99"
            height="137"
            xlink:href="@/assets/images/light_o_2.png"
          />
          <image
            id="light_o_1"
            x="436"
            ...
            width="99"
            height="66"
            xlink:href="@/assets/images/light_o_1.png"
          />
        </g>
        <image
          id="center-house"
...
.cls-54 {
  fill: #fff;
  opacity: 0.9;
  /* 性能优化：告诉浏览器，该元素将会改变哪些属性，让浏览器提前做好优化的准备（比较消耗内存） */
  will-change: opacity;
}
